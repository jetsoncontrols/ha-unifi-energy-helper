"""Config flow for UniFi Energy Helper integration."""
...
class UniFiEnergyHelperConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for UniFi Energy Helper."""
